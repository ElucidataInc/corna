...
'PARENT_FORMULA_COL' : 'Parent Formula', 'COHORT_COL' : 'Cohort Name', 'MQ_FRAGMENT_COL' : 'Component Name',
'MQ_SAMPLE_NAME' : 'Original Filename', 'MQ_COHORT_NAME' : 'Sample Name', 'BACKGROUND_COL' : 'Background Sample'}